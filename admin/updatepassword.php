...
if (isset($_POST['submit']))
 {
   ...
   if ($cpass==$npass) 
   {
		    $row= $con->query("update user set Password='$cpass' where User_id='$id'");
		    if($row) 
		    {
                            ...
                            <div class="col-xs-12">
                                ...
                                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                           <input type="password"  id="opass" name="opass" value="<?php echo $admin_data->Password; ?>">
                                        </div>
                                    </div>
                                   <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Enter Password</label>
                                        <div class="col-sm-9">
