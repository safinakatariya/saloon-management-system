...
$id=$_GET["catid"];//echo $id;exit;
if(!isset($_GET["catid"]))
{
    header('location:service.php');
}
$subcats=$con->query("select * from sub_catogery where Cat_id='$id'");
?>
<!doctype html>
<html lang="en">
	<head>
            ...
            <div class="container">
             ...
             <div class="container" >
                ...
                <div class="text-center padded-box pb-0">
                        <h2>Products Title List</h2>
                        <p class="lead"></p>
                           <div class="padded-box row">
                            <?php 
                            while($row=$subcats->fetch_object())
                            {
                              ?>
                              <div class="col-md-3">
                        <div class="card text-center">
                          <div class="card-body">
                            <a href="see_product.php?subcatid=<?php echo $row->Sub_id; ?>">
                            <img class="card-img-top a card" src="admin/images/<?php echo $row->Image;?>" alt="Card image cap" >
                            <h5 class="card-text zoom"><?php echo $row->Sub_Name; ?></h5>
                            </a>
                          </div>
                        </div>
                    </div>
